...
/** Stable per-browser id so many guests behind one NAT are not one quota bucket. */
...
/** Per-browser guest id for every download fetch (the session rides its cookie). */
